...
import posterImage from '@/assets/images/periferico.png'
    ...
    <svg aria-hidden="true" {...props}>
      <defs>
        ...
        <linearGradient id={`${id}-gradient`}>
          <stop offset="0%" stopColor="#ed7950" />
          <stop offset="100%" stopColor="#c65932" />
        </linearGradient>
        <mask id={`${id}-mask`}>
  ...
  return (
    <section {...props}>
      <h2 className="flex items-center font-mono text-sm font-medium leading-7 text-slate-900">
        <TinyWaveFormIcon
          colors={['fill-orangecesium-500', 'fill-orangecesium-600']}
          ...
          <section className="mt-10 lg:mt-12">
            ...
            >
              {[
                [
                  'Spotify',
                  'https://open.spotify.com/show/39Oqi5NSI1TtqqcuFucNOi',
                  SpotifyIcon,
                ],
                [
                  'Apple Podcasts',
